...
java com.xmlcalabash.drivers.Main -isource=conf/test-config.xml -oresult=report/feature/output1.xml src/test/feature/http-accept-chrome8.xpl
java com.xmlcalabash.drivers.Main -isource=conf/test-config.xml -oresult=- src/test/feature/unknown-uri-pattern.xpl
